  ...
  try {
    ...
    if (!isCorrect || question.type === 'Structured') {
      ...
      try {
        ...
        IMPORTANT: If the Correct Answer contains a currency symbol ('$' or '¢'), the Student Answer MUST also contain that exact symbol. If the symbol is missing, mark it as incorrect with defectCode "CONSTANT_VIOLATION".
