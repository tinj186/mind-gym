    ...
    <div className="overflow-x-auto rounded-2xl border border-slate-200">
      <table className="w-full divide-y divide-slate-200 text-left">
        <thead className="bg-slate-50">
          <tr>
            <th scope="col" className="w-px whitespace-nowrap px-4 py-3 text-xs font-medium text-slate-500 uppercase tracking-wider">Level</th>
            <th scope="col" className="w-px whitespace-nowrap px-4 py-3 text-xs font-medium text-slate-500 uppercase tracking-wider">Topic</th>
            <th scope="col" className="w-px whitespace-nowrap px-4 py-3 text-xs font-medium text-slate-500 uppercase tracking-wider">Sub-topic</th>
            <th scope="col" className="w-px whitespace-nowrap px-4 py-3 text-xs font-medium text-slate-500 uppercase tracking-wider">Type</th>
            <th scope="col" className="w-px whitespace-nowrap px-4 py-3 text-xs font-medium text-slate-500 uppercase tracking-wider">Difficulty</th>
            <th scope="col" className="w-px whitespace-nowrap px-4 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider">To Review</th>
            <th scope="col" className="w-px whitespace-nowrap px-4 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider">Approved</th>
            <th scope="col" className="w-full px-4 py-3 text-right text-xs font-medium text-slate-500 uppercase tracking-wider">Actions</th>
          </tr>
        </thead>
        <tbody className="bg-white divide-y divide-slate-200">
          {data.map((row, idx) => (
            <tr key={idx} className={`hover:bg-slate-50 transition-colors ${row.needsGeneration ? 'bg-orange-50/50' : ''}`}>
              <td className="w-px px-4 py-4 whitespace-nowrap text-sm font-bold text-slate-900">{row.level}</td>
              <td className="w-px px-4 py-4 whitespace-nowrap text-sm text-slate-700">{row.topic}</td>
              <td className="w-px px-4 py-4 whitespace-nowrap text-sm text-slate-500">{row.subtopic || '-'}</td>
              <td className="w-px px-4 py-4 whitespace-nowrap text-sm text-slate-700">{row.type}</td>
              <td className="w-px px-4 py-4 whitespace-nowrap text-sm text-slate-700">{row.difficulty}</td>
              <td className="w-px px-4 py-4 whitespace-nowrap text-center">
              ...
              <td className="w-full px-4 py-4 whitespace-nowrap text-right text-[12px] space-x-2">
                <button 
