        ...
        {session ? (
          <>
            ...
            <div className="flex gap-3 items-center">
              <Link href="/parent/settings" className="flex items-center gap-2 p-2 text-slate-400 hover:text-slate-900 hover:bg-slate-100 rounded-xl transition-colors" title="Settings">
                ⚙️
              </Link>
