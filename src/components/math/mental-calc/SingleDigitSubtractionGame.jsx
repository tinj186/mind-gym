...
export default function SingleDigitSubtractionGame() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('mentalCalcSingleDigitSubtractionScores');
    if (saved) {
  ...
  const finishGame = (finalSplits, totalDuration) => {
    ...
    if (!currentRecord || avgTime < currentRecord) {
      ...
      localStorage.setItem('mentalCalcSingleDigitSubtractionScores', JSON.stringify(newScores));
    }
  };
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen p-6 relative">
        ...
        <div className="text-center max-w-2xl">
          ...
          <h1 className="text-5xl font-black mb-4 text-white">Single Digit Subtraction</h1>
