...
export const patternsWith2DShapesBlueprint = {
  ...
  variants: {
    ...
    'foundation_single_attribute_orientation': 'Identify the next shape in a pattern where ONLY the orientation changes (e.g., Arrow Up, Down, Up, Down, [__]).',
    ...
    'standard_dual_attribute_shape_orientation': 'Identify the missing shape in a pattern where BOTH shape and orientation change (e.g., Triangle Up, Semicircle Down, [__]).',
    ...
    'standard_dual_attribute_orientation_colour': 'Identify the next shape in a pattern where BOTH orientation and colour change (e.g., Red Semicircle Up, Blue Semicircle Down, [__]).',
    'standard_dual_attribute_size_orientation': 'Identify the missing shape in a pattern where BOTH size and orientation change (e.g., Big Triangle Up, Small Triangle Down, [__]).',
