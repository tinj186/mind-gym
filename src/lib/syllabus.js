  ...
  "Primary 1": [
    {
      ...
      subtopics: [
        ...
        { name: "Number Patterns", allowedTypes: [QUESTION_TYPES.SHORT_QUESTION.label, QUESTION_TYPES.MCQ.label], blueprint: 'Provide a number sequence of 5 items up to 100. Exactly ONE item must be "?". Do NOT write the missing number in the question text. CRITICAL: The sequence rule MUST scale based on the difficulty level: Foundation: Use jumps of +1, -1, +2, or -2. Standard: Use jumps of +5, -5, or simple +3, -3. Advanced: Use jumps of +10, -10, or tricky jumps like +4, -4 that cross tens boundaries.', visualType: "NUMBER_PATTERN", vocabulary: ["pattern", "next", "missing"] },
