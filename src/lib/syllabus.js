  ...
  "Primary 2": [
    {
      ...
      subtopics: [
        ...
        { name: "Addition and Subtraction", blueprint: "Algorithms up to 3 digits. Mental calc of 3-digit and ones/tens/hundreds.", visualType: "PART_WHOLE", vocabulary: ["algorithm", "mental calculation", "hundreds"] },
  ...
  "Primary 3": [
    {
      ...
      subtopics: [
        ...
        { name: "Addition and Subtraction", blueprint: "Algorithms up to 4 digits. Mental calc of two 2-digit numbers.", visualType: "PART_WHOLE", vocabulary: ["algorithm", "mental calculation"] },
  ...
  "Primary 4": [
    ...
    },
    {
      ...
      subtopics: [
        ...
        { name: "Addition and Subtraction", blueprint: "Add/sub fractions (denominators <= 12, max two different denominators).", visualType: "FRACTION_BAR", vocabulary: ["denominators", "add", "subtract"] }
      ]
    },
    {
      strand: "Number and Algebra",
      ...
      subtopics: [
        ...
        { name: "Addition and Subtraction", blueprint: "Add/sub decimals up to 2 decimal places.", visualType: "EQUATION", vocabulary: ["decimals", "add", "subtract"] },
